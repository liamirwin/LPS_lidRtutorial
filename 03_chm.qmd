...
-   [Code](https://github.com/tgoodbody/lidRtutorial/blob/master/R/03_chm.R)
...
We once again load the LiDAR, this time we sample points randomly to `decimate` the point cloud and simulate lower density lidar data.

The sampling/return density of your point cloud (particularly from the canopy surface for a CHM) typically dictates the spatial resolution
