...
#' ## Resources
#' 
#' -   [Code](https://github.com/liamirwin/LPS_lidRtutorial/blob/master/R/08_solutions.R)
#' 
#' ## 1-LAS
#' 
...
#' ## 2-ROI
#' 
las <- readLAS("data/MixedEucaNat_normalized.laz", filter = '-set_withheld_flag 0', select = "xyz")
...
circ <- clip_circle(las1, 203930, 7359000, 25)
plot(circ)
