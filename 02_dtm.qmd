...
Visualizing the LiDAR data again, this time to distinguish ground points (\[blue\]{style="color: blue;"}) more effectively.
...
las1 = readLAS("data/zrh_class.laz")
nlas1 = normalize_height(las1, tin())
nlas2 = readLAS("data/zrh_norm.laz")
plot(nlas1)
plot(nlas2)
```
...
Clip a plot somewhere in `zrh_class.laz` (the non-normalized file).
